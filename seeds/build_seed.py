...
def main():
    ...
    out.write("--\n")
    out.write("-- LICENSE: this file is Open Database License (ODbL) v1.0,\n")
    out.write("--   separately from the rest of this repository, which is\n")
    out.write("--   AGPL-3.0-or-later. See LICENSE-DATA at the repo root. ODbL\n")
    out.write("--   share-alike passes to derived databases and cannot be\n")
    out.write("--   narrowed by the surrounding code license, so the split is\n")
    out.write("--   required rather than preferred.\n")
    out.write("--\n")
    out.write("--   Contains information from OpenStreetMap, which is made\n")
    out.write("--   available under the Open Database License (ODbL) v1.0.\n")
    out.write("--   (c) OpenStreetMap contributors\n")
    out.write("--   https://www.openstreetmap.org/copyright\n\n")
    out.write("BEGIN;\n\n")
