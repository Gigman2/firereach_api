...
If a fire starts, get everyone out and call 192. GNFS says to call for help before attempting to deal with a serious fire yourself.',
    ...
    NULL,
    '[{"title":"Electrical Home Fire Safety","publisher":"National Fire Protection Association","year":"","url":"https://www.nfpa.org/education-and-research/home-fire-safety/electrical-safety-in-the-home"},{"title":"Fire Safety Tips for the Workplace (archived snapshot, 7 November 2025)","publisher":"Ghana National Fire Service","year":"","url":"https://web.archive.org/web/20251107114316/https://www.gnfs.gov.gh/fire-safety-tips-workplace.php"},{"title":"Carbon monoxide, in WHO Guidelines for Indoor Air Quality: Selected Pollutants","publisher":"World Health Organization","year":"2010","url":"https://www.ncbi.nlm.nih.gov/books/NBK138710/"},{"title":"How to Use a Fire Extinguisher (archived snapshot, 7 November 2025)","publisher":"Ghana National Fire Service","year":"","url":"https://web.archive.org/web/20251107120210/https://www.gnfs.gov.gh/how-to-use-fire-extinguisher.php"},{"title":"Applied instruction — \"run a generator in the open air, never in a closed room\". No source states this rule; it is FireReach''s application of WHO''s carbon monoxide findings. Needs GNFS/GHS confirmation.","publisher":"FireReach — not an external source","year":"","url":"","unverified":true}]'::jsonb,
    'f1767460a5201d375e3e4def5b38a6b90d8162b58f9ceef11301a21db32f5a47',
    'pending_review',
    NULL,           -- reviewer_name
...
Items that block doors and windows could keep you from escaping, so NFPA says to unblock your exits.',
    ...
    NULL,
    '[{"title":"How to make a home fire escape plan","publisher":"National Fire Protection Association","year":"","url":"https://www.nfpa.org/education-and-research/home-fire-safety/escape-planning"},{"title":"Electrical Home Fire Safety","publisher":"National Fire Protection Association","year":"","url":"https://www.nfpa.org/education-and-research/home-fire-safety/electrical-safety-in-the-home"},{"title":"Safety with cooking equipment","publisher":"National Fire Protection Association","year":"","url":"https://www.nfpa.org/education-and-research/home-fire-safety/cooking"},{"title":"Fire Safety Tips for the Workplace (archived snapshot, 7 November 2025)","publisher":"Ghana National Fire Service","year":"","url":"https://web.archive.org/web/20251107114316/https://www.gnfs.gov.gh/fire-safety-tips-workplace.php"},{"title":"Applied instructions — extending NFPA''s stovetop rule to lamps, candles and coalpots, and NFPA''s security-bars rule to compound gates. Both are FireReach''s extensions, not NFPA''s words. Also: \"most homes here have no smoke alarm\" is FireReach''s statement of local conditions, with no source. Needs GNFS/GHS confirmation.","publisher":"FireReach — not an external source","year":"","url":"","unverified":true}]'::jsonb,
    '3d6c209019da7a7f7489a665d5b8884913984ef8add26c6353b88ce644907f42',
    'pending_review',
    NULL,           -- reviewer_name
    NULL,     -- reviewer_credential
    NULL,
...
**Not covered yet:** firebreaks and cleared strips around buildings, whether to burn on windy harmattan days, what time of day is safer, and keeping water or sand to hand. These are real questions and no Ghanaian source for them could be reached, so they have been left out rather than written from memory.',
    ...
    NULL,
    '[{"title":"Control and Prevention of Bushfires Act, 1990 (P.N.D.C.L. 229) — sections 1, 2, 6, 8, 11 and 12. Section text read on GhanaLegal, a third-party legal portal, because the Parliament of Ghana repository returns HTTP 403. Not confirmed against a government-published copy, and not checked for later amendment.","publisher":"Republic of Ghana (text read via GhanaLegal)","year":"1990","url":"https://ghanalegal.com/laws_subdomain/acts/id/506/control-and-prevention-of-bushfires-act/","unverified":true},{"title":"Control and Prevention of Bushfires Act, 1990 (P.N.D.C.L. 229) — FAOLEX record","publisher":"Food and Agriculture Organization of the United Nations (ECOLEX/FAOLEX)","year":"1990","url":"https://www.ecolex.org/details/legislation/control-and-prevention-of-bushfires-act-1990-pndcl-229-lex-faoc040958/"},{"title":"How to Use a Fire Extinguisher (archived snapshot, 7 November 2025)","publisher":"Ghana National Fire Service","year":"","url":"https://web.archive.org/web/20251107120210/https://www.gnfs.gov.gh/how-to-use-fire-extinguisher.php"},{"title":"How to make a home fire escape plan","publisher":"National Fire Protection Association","year":"","url":"https://www.nfpa.org/education-and-research/home-fire-safety/escape-planning"}]'::jsonb,
    '770e0bcc1d077535ebedad020569ecdc2cdd13dca122c8c0d291f1d24c809a2d',
    'pending_review',
    NULL,           -- reviewer_name
    NULL,     -- reviewer_credential
    NULL,
...
INSERT INTO safety_content (
    ...
    NULL,
    '[{"title":"How to make a home fire escape plan","publisher":"National Fire Protection Association","year":"","url":"https://www.nfpa.org/education-and-research/home-fire-safety/escape-planning"},{"title":"Fire Safety Tips for the Workplace (archived snapshot, 7 November 2025)","publisher":"Ghana National Fire Service","year":"","url":"https://web.archive.org/web/20251107114316/https://www.gnfs.gov.gh/fire-safety-tips-workplace.php"},{"title":"How to Use a Fire Extinguisher (archived snapshot, 7 November 2025)","publisher":"Ghana National Fire Service","year":"","url":"https://web.archive.org/web/20251107120210/https://www.gnfs.gov.gh/how-to-use-fire-extinguisher.php"},{"title":"Gap flagged for the reviewer — this guide does not tell the reader to check a door for heat before opening it. No source among those cited states it, so it was left out rather than written from memory. Please advise whether to add it.","publisher":"FireReach — known gap, not a source","year":"","url":"","unverified":true}]'::jsonb,
    'b459fc5bbe5b0a0b9d40877f26141c5b03b2423583d41b89996dfdfc8015f642',
    'pending_review',
    NULL,           -- reviewer_name
    NULL,     -- reviewer_credential
    NULL,
...
INSERT INTO safety_content (
    ...
    NULL,
    '[{"title":"How to Use a Fire Extinguisher (archived snapshot, 7 November 2025)","publisher":"Ghana National Fire Service","year":"","url":"https://web.archive.org/web/20251107120210/https://www.gnfs.gov.gh/how-to-use-fire-extinguisher.php"},{"title":"Fire extinguishers","publisher":"National Fire Protection Association","year":"","url":"https://www.nfpa.org/education-and-research/home-fire-safety/fire-extinguishers"},{"title":"NFPA 10, Standard for Portable Fire Extinguishers — cited at document level only. The standard''s text is paywalled, so the clause containing PASS was never read and no section number or edition year is given. PASS itself is quoted from GNFS and from NFPA''s free public-education page, so nothing in this guide depends on NFPA 10.","publisher":"National Fire Protection Association","year":"","url":"https://www.nfpa.org/codes-and-standards/nfpa-10-standard-development/10","unverified":true}]'::jsonb,
    '08c5aec61fa223afc9980959828b9ed43ff2175624d4299efd5cc52a46a3e60d',
    'pending_review',
    NULL,           -- reviewer_name
    NULL,     -- reviewer_credential
    NULL,
